...
const addOne = (arr) => {
  const newArray = [];
  arr.forEach(function (value) { newArray.push(value + 1) });
  return newArray;
};
...
const addExclamation = (arr) => {
  const newArray1 = [];
  arr.forEach(function (value) {newArray1.push(value + '!') });
  return newArray1;
};
...
const allUpperCase = (arr) => {
  const newArray2 = [];
  arr.forEach(function (value) {newArray2.push(value.toUpperCase())})
  return newArray2;
};
...
const speaker = (words, callback) => {
  ...
  words.forEach(string => {
    newArray3.push(callback(string));
  });
  return newArray3;
};
